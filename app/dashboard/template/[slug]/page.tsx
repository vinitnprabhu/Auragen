    ...
    <div>
      <div className='flex justify-between mx-5'>
        ...
        <Button onClick={handleCopy}>
          <Copy /><span className="m1-2">Copy</span>
        </Button>
      </div>
      ...
      <div className="col-span-2">
        <Editor ref={editorRef} intitialValue="Generated content will appear here" previewStyle="vertical" height="600px" initialEditType="wysiwyg" useCommandShortcut={true} />
      </div>
    </div>
  </div>
  );
